# Ported from kaizer-platform@d5fd482 server/pipeline_v2/pipeline_v2/render/edl_builder.py.
# Changes from upstream: relocated into pipeline_core/podcast/ (pipeline_v2 was removed on
# this side); pure-stdlib module, code unchanged.
