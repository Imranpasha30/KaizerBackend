...
PLANS: Dict[str, Dict[str, Any]] = {
    PLAN_FREE: {
        ...
        "advanced_seo":      False,     # trends + benchmark + retry loop
        "analytics_days":    7,
        ...
        "byok":              False,
        "highlights": [
            "5 clips edited / month",
            "1 integration (Meta / Instagram / Facebook / YouTube)",
            "1 language",
            "Basic AI SEO (no trends / benchmark)",
            "7-day insights",
            "Community support",
        ],
    },
    PLAN_CREATOR: {
        ...
        "byok":              False,
        "highlights": [
            "50 clips edited / month",
            "3 integrations (Meta / Instagram / Facebook / YouTube)",
            "3 languages",
            "Full AI SEO (Trends + top-5 benchmark)",
            "Basic publishing plans + scheduling",
            "30-day insights",
            "Email support",
        ],
    },
    PLAN_PRO: {
        ...
        "byok":              False,
        "highlights": [
            "200 clips edited / month",
            "10 integrations (Meta / Instagram / Facebook / YouTube)",
            "All 9 languages",
            "Full power-ups (Grounding + Trends + benchmark + retry ≥95)",
            "Channel groups + publishing plans + quiet hours",
            "Thumbnail A/B testing",
            "Veo 3 video generation (10 / month)",
            "180-day insights + performance leaderboard",
    ...
    PLAN_AGENCY: {
        ...
        "byok":              True,
        "highlights": [
            "Unlimited clips edited",
            "Unlimited integrations (Meta / Instagram / Facebook / YouTube)",
            "5 team seats",
            "Unlimited Veo 3 video generation",
            "Competitor research + full Trend Finder",
